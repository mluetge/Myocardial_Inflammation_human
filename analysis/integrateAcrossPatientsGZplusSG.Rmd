...
seurat.int <- RunPCA(object = seurat.int, npcs = 30, verbose = FALSE)
seurat.int <- RunTSNE(object = seurat.int, reduction = "pca", dims = 1:30)
seurat.int <- RunUMAP(object = seurat.int, reduction = "pca", dims = 1:30)
