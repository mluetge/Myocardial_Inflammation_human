...
saveRDS(seurat, file = paste0(basedir, 
                              "/data/humanHearts_merged_Normal_HF_Myocarditis.rds"))

saveRDS(seuratSub, file = paste0(basedir, 
                              "/data/humanHearts_merged_Normal_Myocarditis.rds"))

saveRDS(seuratSub2, file = paste0(basedir, 
                              "/data/humanHearts_merged_Normal_HF.rds"))

write.table(DEgenes,
            file=paste0(basedir,
                        "/data/humanHearts_NORMALvsHFvsMYO_overallDEGenes.txt"),
